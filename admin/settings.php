        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <input type="text" name="registration_key" id="registration_key"
                               value="<?php echo get_option('registration_key', true); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <input type="tel" name="pay_pal_id" id="pay_pal_id"
                               value="<?php echo get_option('pay_pal_id', true); ?>">
                    </td>
                </tr>
            </table>
